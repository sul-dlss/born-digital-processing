# Disk Imaging Strategy and Workflows

## Table of contents

* [Introduction](#introduction)
* [1: Choosing an imaging strategy](#choosing-an-imaging-strategy)
* [2: Before imaging](#before-imaging)
* [3: Imaging](#imaging)
* [4: After imaging](#after-imaging)

## Introduction

This documentation is an overview of workflows for disk imaging and file transferring at the Born Digital Preservation Lab (BDPL), a reformatting lab that is part of Stanford University Libraries.
It has been compiled and deduped from multiple standalone imaging workflows.
...
In this step, you will reformat your computer media through disk imaging
